...
void GLWidget::testGPIO(){
   ...
   // while(getkey() != 27) 	   
       //gpio36 = 36,      // J21 - Pin 32 - Unused - AO_DMIC_IN_CLK   	// pin32 = gpio36; // Disp1
       //gpio37 = 37,      // J21 - Pin 16 - Unused - AO_DMIC_IN_DAT 	// pin16 = gpio37;  // Vmod1	
       //gpio38 = 38,      // J21 - Pin 13 - Bidir  - GPIO20_AUD_INT  	//  pin13 = gpio38;  //sync
       //gpio63 = 63,      // J21 - Pin 33 - Bidir  - GPIO11_AP_WAKE_BT 	 //  pin33 = gpio63;  // Vmod2
       //gpio184 = 184,    // J21 - Pin 18 - Input  - GPIO16_MDM_WAKE_AP 	 //  pin18 = gpio184;  //save_file
       //gpio186 = 186,    // J21 - Pin 31 - Input  - GPIO9_MOTION_INT  	//  pin31 = gpio186;  //power_off
       //gpio187 = 187,    // J21 - Pin 37 - Output - GPIO8_ALS_PROX_INT
       //gpio219 = 219,    // J21 - Pin 29 - Output - GPIO19_AUD_RST  		 // pin29 = gpio219; // Disp2

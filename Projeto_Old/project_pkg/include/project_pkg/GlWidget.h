...
public:
  ...
  //GPIO Pins
    ...
    jetsonTX1GPIONumber pin29; // Input
	jetsonTX1GPIONumber pin37; // Input
    jetsonTX1GPIONumber pin31; // Input
    jetsonTX1GPIONumber pin18;
    jetsonTX1GPIONumber pin33;
    jetsonTX1GPIONumber pin16;
    jetsonTX1GPIONumber pin32;
    jetsonTX1GPIONumber pin13;
	//pin29 - b1
	//pin37 - b2
	//pin31 - b3
	//pin18 - b4
